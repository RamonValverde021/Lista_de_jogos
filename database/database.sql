...
CREATE DATABASE IF NOT EXISTS bd_games DEFAULT 
CHARACTER SET utf8 
...
Seleciona e organiza as colunas que serão exibidas na tabela

FROM jogos j
'jogos' é base da junção entre as tabelas e definimos um apelido 'j'

JOIN generos g ON j.genero = g.cod
Aqui criamos a primeira relação, que é entre a tabela 'generos' como a tabela 'jogos'
referenciando a chave estrangeira 'j.genero' com a chave primaria 'g.cod'

JOIN produtoras p ON j.produtora = p.cod;
Depois criamos a segunda relação, que é entre a tabela 'produtoras' como a tabela 'jogos'
referenciando a chave estrangeira 'j.produtora' com a chave primaria 'p.cod'
*/
